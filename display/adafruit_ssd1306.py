...
"""Replacing this import with the local framebuf. We know its a CircuitPython
import, so we can skip the try catch."""
# try:
...
from inverted_framebuf import adafruit_framebuf as framebuf
_FRAMEBUF_FORMAT = framebuf.MVLSB
